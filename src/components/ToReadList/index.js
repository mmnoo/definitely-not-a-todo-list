      ...
      <Box>
        <Box direction="row" pad="small" gap="small" align="center">
          <Grid
            ...
            fill
          >
            <Text tag="div" color="dark-4" weight="bold">
              Read
            </Text>
            <Text tag="div" color="dark-4" weight="bold">
              Book
            </Text>
            <Text tag="div" textAlign="center" color="dark-4" weight="bold">
              Delete
            </Text>
          </Grid>
        </Box>
        {this.state.elements.map((element, index) => (
          ...
          >
            <CheckBox
              ...
              onChange={e => this.changeRead(e, element)}
            />
            <Box fill>
              <Text
